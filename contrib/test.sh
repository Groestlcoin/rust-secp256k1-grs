...
FEATURES="groestlcoin-hashes global-context lowmemory rand recovery serde std alloc groestlcoin-hashes-std rand-std"
...
if [ "$DO_FEATURE_MATRIX" = true ]; then
    ...
    # Examples
    cargo run --example sign_verify --features=groestlcoin-hashes-std
    cargo run --example sign_verify_recovery --features=recovery,groestlcoin-hashes-std
